...
// TODO: add tests
// void check_helper(const char* code, const char* type, const char* name, const
// char* init, bool has_assign, bool is_ref) {
//   rcrl::PluginParser pp("test.txt");
...
//     check_helper("std::vector<int> vec = {};", "std::vector<int>", "vec",
//     "{}", true, false);
//     check_helper("std::vector<decltype(my_lambda<templated>())> vec = {};",
//     "std::vector<decltype(my_lambda<templated>())>",
//                  "vec", "{}", true, false);
//     check_helper("std::map<std::vector<std::string>, decltype(*wtf())> vec =
//     {};",
//                  "std::map<std::vector<std::string>, decltype(*wtf())>",
//                  "vec", "{}", true, false);
